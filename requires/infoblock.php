<div class="row">
    ...
    <div class="col-md-3 portfolio-item">
        <h4 class="contact-header-blauw">social media</h4>
    ...
    <div class="col-md-3 portfolio-item">
        <h4><a href="referenties.php" class="contact-header-blauw">referenties</a></h4>
        <p>klik <a href="referenties.php">hier</a> voor referenties</p>
    </div>
    <div class="col-md-3 portfolio-item">
        <h4><a href="http://www.nbpo.nl" target="blank" class="contact-header-blauw">NBPO</h4>
        <a href="http://www.nbpo.nl" target="blank"><img class="img-responsive" src="img/nbpo.png"></a>
    </div>
</div>